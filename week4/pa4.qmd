...
```{r}
# code for Q2, https://www.spsanderson.com/steveondata/posts/2024-11-26/#:~:text=Columns%20in%20R-,Using%20the%20Subset()%20Function,ones%20you%20want%20to%20remove.
...
```{r regional-totals}
cont_region <- read_xlsx("data/SIPRI-Milex-data-1949-2024.xlsx", 
...
# code for Q5
military_clean <- 
  anti_join(military_clean, cont_region,
...
```{r}
# code for Q6
no_spending <- military_clean |>
  filter(if_all(`1988` : `2023`, is.na))
```
...
military_long |> 
  ...
  ggplot(aes(x = Country, y = spending)) +
  geom_boxplot()
