...
ggplot(data = penguins, aes (x = species, fill = species)) + 
  geom_bar() +
  labs (title = "Bar Graph of 3 Different Penguin Species", x = "Species", y = "Number of Penguins")
```
...
ggplot(data = penguins, aes(x = bill_length_mm, y = bill_depth_mm)) +
  geom_point() +
  labs (title = "Scatterplot of Relationship Between Bill Length & Bill Depth", x = "Bill Length", y = "Bill Depth")
```
